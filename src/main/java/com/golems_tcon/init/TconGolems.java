...
public class TconGolems {
	...
	public static final String VERSION = "7.1.9-0";
	public static final String DEPS = "required-after:golems@[7.1.7,);required-after:tconstruct@[1.12.2-2.12.0.135,);after:futuremc;after:nb";
